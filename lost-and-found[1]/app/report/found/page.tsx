...
const formSchema = z.object({
  ...
  dateFound: z.date({
    required_error: "Please select a date when the item was found.",
  }),
    ...
    <div className="container max-w-3xl py-10">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Fill out the form below with details about the item you found. This will help the owner identify and claim
            it.
          </CardDescription>
        </CardHeader>
        <CardContent>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>Where did you find the item?</FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-col">
                      ...
                      <FormDescription>When did you find the item?</FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      Describe the item in detail, but avoid including unique identifying features that only the owner
                      would know.
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                ...
                <div className="mt-2 flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="mt-2 text-xs text-gray-500">
                      Upload a clear image of the item to help the owner identify it.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>How should the owner contact you to claim the item?</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
